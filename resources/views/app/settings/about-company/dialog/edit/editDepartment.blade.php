<div class="modal-content">
    ...
    <form id="formEditDepartment" class="form-block">
        <div class="modal-body">
            ...
            <div class="row g-2">
                <div class="col-md-6">
                    <label class="form-label" for="edit_departmentName">ชื่อสังกัด / ฝ่าย</label>
                ...
                <div class="col-md-6">
                    <label class="form-label" for="edit_company">ชื่อบริษัท</label>
                ...
                <div class="col-md-6">
                    <label class="form-label" for="edit_statusForDep">สถานะการใช้งาน</label>
                    <select id="edit_statusForDep" name="edit_statusForDep" class="form-select select2"
